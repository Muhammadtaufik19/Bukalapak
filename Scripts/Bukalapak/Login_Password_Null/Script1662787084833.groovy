...
WebUI.setText(findTestObject('Object Repository/Bukalapak.com/Page_Login ke Akun  Bukalapak/input_Lanjut_Password'), '')
...
WebUI.verifyElementText(findTestObject('Notifikasi_Login/Page_Login ke Akun  Bukalapak/p_Password wajib diisi, ya'), 'Password wajib diisi, ya.')
